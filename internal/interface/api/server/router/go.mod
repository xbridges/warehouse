module github.com/xbridges/warehouse/internal/interface/api/server/router
...
replace (
	...
	github.com/xbridges/warehouse/internal/interface/api/server/auth v0.0.1 => ../auth
	github.com/xbridges/warehouse/internal/interface/api/server/handler v0.0.1 => ../handler
	github.com/xbridges/warehouse/internal/interface/api/server/httputils v0.0.1 => ../httputils
)
